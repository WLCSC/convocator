...
class ChargesControllerTest < ActionController::TestCase
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post :create, charge: { amount: @charge.amount, comment: @charge.comment, description: @charge.description, icon: @charge.icon }
    end
  ...
  test "should update charge" do
    patch :update, id: @charge, charge: { amount: @charge.amount, comment: @charge.comment, description: @charge.description, icon: @charge.icon }
    assert_redirected_to charge_path(assigns(:charge))
  end
